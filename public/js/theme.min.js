...
!(function(t) {
    var e = {
            ...
            for (
                var a = document.querySelectorAll(".cs-password-toggle"),
                    e = function(e) {
                        ...
                        a[e]
                            .querySelector(".cs-password-toggle-btn")
                            .addEventListener(
                                "click",
                                function(e) {
        ...
        customFileInput: function() {
            "object" ===
                ("undefined" == typeof bsCustomFileInput
                    ? "undefined"
                    : _typeof(bsCustomFileInput)) && bsCustomFileInput.init();
        },
            ...
            for (
                var t = document.querySelectorAll(".cs-file-drop-area"),
                    e = function(e) {
                        ...
                        t[e]
                            .querySelector(".cs-file-drop-btn")
                                        ...
                                        if (
                                            ...
                                            t.startsWith("data:video")
                                                ? ((s.innerHTML = ""),
                                                  (s.className = ""),
                                                  (s.className =
                                                      "cs-file-drop-icon fa fa-video"))
                                                : ((s.innerHTML = ""),
                                                  (s.className = ""),
                                                  (s.className =
                                                      "cs-file-drop-icon fa fa-file-text"));
                                    }),
        ...
        bsAccordion: function() {
            for (
                var n = document.querySelectorAll(".accordion-alt"),
                    ...
                    e = function(e) {
                        for (
                            var t = n[e].querySelectorAll(
                                    '[data-toggle="collapse"]'
                                ),
                                a = n[e].querySelectorAll(".card"),
                                r = 0;
                            r < t.length;
                            r++
                        )
                            t[r].addEventListener("click", function() {
                                ...
                                (this.classList.contains("collapsed")
                                    ? this.classList.contains("custom-control")
                                        ? s
                                        : o
                                    : this.classList.contains("custom-control")
                                    ? o
        ...
        multilevelDropdown: function() {
            t(".dropdown-menu [data-toggle='dropdown']").on("click", function(
                e
            ) {
                e.preventDefault(),
                    e.stopPropagation(),
        ...
        offcanvas: function() {
            for (
                ...
                e[t].addEventListener("click", function(e) {
                    e.preventDefault(),
                        document
                            .getElementById(e.currentTarget.dataset.offcanvasId)
        ...
        carousel: function() {
            !(function(e, t, a) {
                ...
                function(e, t) {
                    ...
                    if (null != l) {
                        for (
                            var i = l.querySelectorAll("[data-goto]"), d = 0;
                            d < i.length;
                            d++
                        )
                    ...
                    if (
                        ...
                        var f = o.getInfo(),
                            ...
                            h = s.querySelector(
                                ".cs-carousel-progress .progress-bar"
                            );
                        (v.innerHTML = f.displayIndex),
                            (p.innerHTML = f.slideCount),
                            (h.style.width =
                                (f.displayIndex / f.slideCount) * 100 + "%"),
                            o.events.on("indexChanged", function() {
                                var e = o.getInfo();
                                (v.innerHTML = e.displayIndex),
                                    (h.style.width =
                                        (e.displayIndex / e.slideCount) * 100 +
                                        "%");
                            });
                    }
                }
                ...
                for (
                    var e = function(e) {
                            var a = t[e].dataset.countdown,
                                r = t[e].querySelector(
                                    ".cs-countdown-days .cs-countdown-value"
                                ),
                                n = t[e].querySelector(
                                    ".cs-countdown-hours .cs-countdown-value"
                                ),
                                o = t[e].querySelector(
                                    ".cs-countdown-minutes .cs-countdown-value"
                                ),
                                s = t[e].querySelector(
                                    ".cs-countdown-seconds .cs-countdown-value"
                                ),
                                c = void 0,
                                l = void 0,
                                i = void 0,
                ...
                for (
                    var b = function(e) {
                            var t = JSON.parse(s[e].dataset.pieChart),
                                ...
                                r = void 0;
                            if (
                                (s[e].classList.add("cz-pie-chart-" + e),
                                null != a)
                            ) {
                                r = JSON.parse(a);
                ...
                var o = document.querySelectorAll(".cs-range-slider"),
                    e = function(e) {
                        var t = o[e].querySelector(".cs-range-slider-ui"),
                            r = o[e].querySelector(
                                ".cs-range-slider-value-min"
                            ),
                            n = o[e].querySelector(
                                ".cs-range-slider-value-max"
                            ),
                            a = {
                                dataStartMin: parseInt(
                                    o[e].dataset.startMin,
                                    10
                                ),
                                dataStartMax: parseInt(
                                    o[e].dataset.startMax,
                                    10
                                ),
            ...
            var a = function(e) {
                for (
                    var t = document.querySelector(e),
                        a = t.parentNode.querySelectorAll(".cs-view"),
                        r = 0;
                    r < a.length;
                    r++
                )
                            ...
                            for (var a = 0; a < e.length; a++)
                                (e[a].checked = !1),
                                    e[a].dataset.checkboxToggleClass &&
                                        document
                                            .querySelector(e[a].dataset.target)
                                            .classList.remove(
                                                e[a].dataset.checkboxToggleClass
                                            );
                    });
