! function(e) {
    ...
    return e.cleanData = function(t) {
        ...
        for (var i, a, s = n.call(arguments, 1), r = 0, o = s.length; r < o; r++)
            for (i in s[r]) a = s[r][i], s[r].hasOwnProperty(i) && void 0 !== a && (e.isPlainObject(a) ? t[i] = e.isPlainObject(t[i]) ? e.widget.extend({}, t[i], a) : e.widget.extend({}, a) : t[i] = a);
        return t
        ...
        e.fn[t] = function(s) {
            ...
            return r ? this.length || "instance" !== s ? this.each(function() {
                ...
                return "instance" === s ? (l = i, !1) : i ? e.isFunction(i[s]) && "_" !== s.charAt(0) ? (n = i[s].apply(i, o)) !== i && void 0 !== n ? (l = n && n.jquery ? l.pushStack(n.get()) : n, !1) : void 0 : e.error("no such method '" + s + "' for " + t + " widget instance") : e.error("cannot call methods on " + t + " prior to initialization; attempted to call method '" + s + "'")
        ...
        _setOptionClasses: function(t) {
            var n, i, a;
            for (n in t) a = this.classesElementLookup[n], t[n] !== this.options.classes[n] && a && a.length && (i = e(a.get()), this._removeClass(a, n), i.addClass(this._classes({
                element: i,
                keys: n,
                classes: t,
                add: !0
        ...
        _classes: function(t) {
            function n(n, s) {
                var r, o;
                for (o = 0; o < n.length; o++) r = a.classesElementLookup[n[o]] || e(), r = e(t.add ? e.unique(r.get().concat(t.element.get())) : r.not(t.element).get()), a.classesElementLookup[n[o]] = r, i.push(n[o]), s && t.classes[n[o]] && i.push(t.classes[n[o]])
            }
            var i = [],
                a = this;
            return t = e.extend({
        ...
        e.Widget.prototype["_" + t] = function(i, a, s) {
            ...
            var r, o = a ? !0 === a || "number" == typeof a ? n : a.effect || n : t;
            "number" == typeof(a = a || {}) && (a = {
                duration: a
            }), r = !e.isEmptyObject(a), a.complete = s, a.delay && i.delay(a.delay), r && e.effects && e.effects.effect[o] ? i[t](a) : o !== t && i[o] ? i[o](a.duration, a.easing, s) : i.queue(function(n) {
...
function(e) {
    ...
    return function() {
        function t(e, t, n) {
            return [parseFloat(e[0]) * (g.test(e[0]) ? t / 100 : 1), parseFloat(e[1]) * (g.test(e[1]) ? n / 100 : 1)]
        }
        ...
        e.position = {
            scrollbarWidth: function() {
                ...
                var t, n, i = e("<div style='display:block;position:absolute;width:50px;height:50px;overflow:hidden;'><div style='height:100px;width:auto;'></div></div>"),
                    s = i.children()[0];
                return e("body").append(i), t = s.offsetWidth, i.css("overflow", "scroll"), n = s.offsetWidth, t === n && (n = i[0].clientWidth), i.remove(), a = t - n
            },
            ...
            a = e.extend({}, a);
            var g, p, f, h, m, y, v = e(a.of),
                b = e.position.getWithinInfo(a.within),
                w = e.position.getScrollInfo(b),
                P = (a.collision || "flip").split(" "),
                k = {};
            return y = i(v), v[0].preventDefault && (a.at = "left top"), p = y.width, f = y.height, h = y.offset, m = e.extend({}, h), e.each(["my", "at"], function() {
                var e, t, n = (a[this] || "").split(" ");
                1 === n.length && (n = o.test(n[0]) ? n.concat(["center"]) : l.test(n[0]) ? ["center"].concat(n) : ["center", "center"]), n[0] = o.test(n[0]) ? n[0] : "center", n[1] = l.test(n[1]) ? n[1] : "center", e = u.exec(n[0]), t = u.exec(n[1]), k[this] = [e ? e[0] : 0, t ? t[0] : 0], a[this] = [c.exec(n[0])[0], c.exec(n[1])[0]]
            }), 1 === P.length && (P[1] = P[0]), "right" === a.at[0] ? m.left += p : "center" === a.at[0] && (m.left += p / 2), "bottom" === a.at[1] ? m.top += f : "center" === a.at[1] && (m.top += f / 2), g = t(k.at, p, f), m.left += g[0], m.top += g[1], this.each(function() {
                var i, o, l = e(this),
                    u = l.outerWidth(),
                    c = l.outerHeight(),
                    d = n(this, "marginLeft"),
                ...
                "right" === a.my[0] ? C.left -= u : "center" === a.my[0] && (C.left -= u / 2), "bottom" === a.my[1] ? C.top -= c : "center" === a.my[1] && (C.top -= c / 2), C.left += W[0], C.top += W[1], i = {
                    marginLeft: d,
                    marginTop: y
                }, e.each(["left", "top"], function(t, n) {
                    e.ui.position[P[t]] && e.ui.position[P[t]][n](C, {
                        targetWidth: p,
                        targetHeight: f,
                        elemWidth: u,
                        elemHeight: c,
                    ...
                    var t = h.left - C.left,
                        ...
                        g = {
                            ...
                            vertical: o < 0 ? "top" : i > 0 ? "bottom" : "middle"
                        };
                    p < u && r(t + n) < p && (g.horizontal = "center"), f < c && r(i + o) < f && (g.vertical = "middle"), s(r(t), r(n)) > s(r(i), r(o)) ? g.important = "horizontal" : g.important = "vertical", a.using.call(this, e, g)
                }), l.offset(e.extend(C, {
                    using: o
                }))
            })
            ...
            fit: {
                left: function(e, t) {
                    ...
                    t.collisionWidth > r ? l > 0 && u <= 0 ? (n = e.left + l + t.collisionWidth - r - a, e.left += l - n) : e.left = u > 0 && l <= 0 ? a : l > u ? a + r - t.collisionWidth : a : l > 0 ? e.left += l : u > 0 ? e.left -= u : e.left = s(e.left - o, e.left)
                },
                top: function(e, t) {
                    var n, i = t.within,
                    ...
                    t.collisionHeight > r ? l > 0 && u <= 0 ? (n = e.top + l + t.collisionHeight - r - a, e.top += l - n) : e.top = u > 0 && l <= 0 ? a : l > u ? a + r - t.collisionHeight : a : l > 0 ? e.top += l : u > 0 ? e.top -= u : e.top = s(e.top - o, e.top)
                }
            },
            flip: {
                left: function(e, t) {
                    var n, i, a = t.within,
                        ...
                        f = -2 * t.offset[0];
                    c < 0 ? ((n = e.left + d + p + f + t.collisionWidth - o - s) < 0 || n < r(c)) && (e.left += d + p + f) : g > 0 && ((i = e.left - t.collisionPosition.marginLeft + d + p + f - l) > 0 || r(i) < g) && (e.left += d + p + f)
                },
                top: function(e, t) {
                    var n, i, a = t.within,
                        ...
                        f = -2 * t.offset[1];
                    c < 0 ? ((i = e.top + d + p + f + t.collisionHeight - o - s) < 0 || i < r(c)) && (e.top += d + p + f) : g > 0 && ((n = e.top - t.collisionPosition.marginTop + d + p + f - l) > 0 || r(n) < g) && (e.top += d + p + f)
                }
            },
            flipfit: {
                left: function() {
